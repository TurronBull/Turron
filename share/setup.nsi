...
!define URL http://www.turron.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/turron.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\turron-qt.exe
...
OutFile turron-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/turron-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/turrond.exe
    ...
    #Delete /REBOOTOK $INSTDIR\turron.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\turron-qt.exe
